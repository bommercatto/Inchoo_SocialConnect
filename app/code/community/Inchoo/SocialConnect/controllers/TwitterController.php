    ...
    protected function _connectCallback() {
        ...
        if(Mage::getSingleton('customer/session')->isLoggedIn()) {
            ...
            Mage::getSingleton('core/session')->addSuccess(
                $this->__('Your Twitter account is now connected to your store account. You can now login using our Twitter Connect button or using store account credentials you will receive to your email address.')
            );
        ...
        Mage::getSingleton('core/session')->addSuccess(
            $this->__('Your Twitter account is now connected to your new user account at our store. Now you can login using our Twitter Connect button.')
        );        
